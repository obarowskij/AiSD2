...
| 6.  | Dane: Lista strażników i lista punktów obserwacyjnych <br /> Wynik: Harmonogram pracy strażników ustawiany według minimalnej liczby odsłuchań melodii w trakcie pracy | Potrzeba ochrony płotu | Drzewo przedziałowe, słownik | RMQ | Tutak |
<a id='6'></a>
# Algorytm Grahama
### 1.Kroki algorytmu:
